...
def buy():
    ...
    if request.method == "GET":
        ...
        # check for p
        if shares < 0:
            return apology("input isn't a positive integer")
        ...
        userCash = db.execute("SELECT cash FROM users")
        ...
        ''' 
        #else:
        db.execute("INSERT INTO purchases (price, shares) VALUES (?, ?)", stockPrice, shares)
